...
with ui.accordion(id="acc", open=["Introduction", "Parametrization", "Results"]):  
    with ui.accordion_panel("Introduction"):
        with ui.div(class_="py-4 mx-auto text-left"):
            ui.markdown(
                f"""
                This application simulates a clinical trial of a cancer drug using the framework presented in the article [Why effect sizes are systematically larger for progression-free survival than overall survival in cancer drug trials: prognostic scores as a way forward](https://www.ejcancer.com/article/S0959-8049(24)01713-1/fulltext) (L Locher, M Serra-Burriel, D Trapani, E Nussli & KN Vokinger, 2024).
